...
-(void)setStatus:(BGStatus *)status{
    ...
    if (status.pic_urls.count) { // 有配图
        ...
        CGSize photosSize = [BGStatusPhotosView sizeWithCount:status.pic_urls.count];
    ...
    if (status.retweeted_status) {
        ...
        if (retweeted_status.pic_urls.count) { // 转发微博有配图
            ...
            CGSize retweetPhotosSize = [BGStatusPhotosView sizeWithCount:retweeted_status.pic_urls.count];
